...
void UIElement::initUI()
{
	...
	m_YYTVideoShowDlg = YYTPluginManage::getInstance()->getYYTVideoShow();//YYTVideoShow::getInstance();
	addDockWidget(m_YYTVideoShowDlg);

	m_YYTConsultaApplyDlg = YYTPluginManage::getInstance()->getConsultationApplyDlg();//ConsultationApplyDlg::getInstance();
	//addWidget(tr("YYTConsultationApply"), QString(""), m_YYTConsultaApplyDlg);
	addWidget(FromBits("会诊申请"), QString(""), m_YYTConsultaApplyDlg);

	m_YYTPatientCaseDlg = YYTPluginManage::getInstance()->getPatientCase();
	//addWidget(tr("YYTPatientCase"), QString(""), m_YYTPatientCaseDlg);
	addWidget(FromBits("患者病历"), QString(""), m_YYTPatientCaseDlg);

	m_YYTRemoteImageDlg = YYTPluginManage::getInstance()->getRemoteImageDlg();//new RemoteImageDlg;
	//addWidget(tr("YYTRemoteImage"), QString(""), m_YYTRemoteImageDlg);
	addWidget(FromBits("远程影像"), QString(""), m_YYTRemoteImageDlg);

	m_YYTScreenShareDlg = YYTPluginManage::getInstance()->getScreenShareDlg();//new ScreenShareDlg;
	//addWidget(tr("YYTScreenShare"), QString(""), m_YYTScreenShareDlg);
	addWidget(FromBits("屏幕共享"), QString(""), m_YYTScreenShareDlg);

	m_YYTConsultaReportDlg = YYTPluginManage::getInstance()->getConsultationReportDlg();//ConsultationReportDlg::getInstance();
	//addWidget(tr("YYTConsultaReport"), QString(""), m_YYTConsultaReportDlg);
	addWidget(FromBits("会诊报告"), QString(""), m_YYTConsultaReportDlg);
}
...
void UIElement::initProgressBar()
{
   ...
   //addDockWidget(progressBarsWidget);
